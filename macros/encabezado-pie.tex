...
\fancyfoot[EL]{
  \href{\dirRepo}{\small\github
    ¡Aportá con correcciones, subiendo ejercicios, \yellow{\faIcon{star}} al repo, críticas, todo sirve.
    }
}    % pie izquierdo pares
\fancyfoot[OL]{
  \href{\dirTelegram}{\small\telegram ¿Errores? Avisá así se corrige y ganamos todos.
  }
