...
%%% Emoticones
\def\poo{\faIcon{poo}}
\def\angry{\faIcon[regular]{angry}}
\def\atencion{\faIcon{exclamation-triangle}}
\def\meh{\faIcon[regular]{meh}}
\def\mehBlank{\faIcon[regular]{meh-blank}}
\def\rollingEyes{\faIcon[regular]{meh-rolling-eyes}}
\def\surprise{\faIcon[regular]{surprise}}
\def\magic{\href{https://www.youtube.com/watch?v=4u20AEDYhcw}{\faIcon{magic}}\xspace}
\def\python{\texttt{Python} \faIcon[regular]{python}\xspace}
\def\copyPaste{
  \begin{center}
