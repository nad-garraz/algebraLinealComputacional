...
\hypersetup{
    pdftitle={Apunté Único de Álgebra Lineal Computacional},
    pdfauthor={Por los alumnos y exalumnos de ALC},
    pdfkeywords={algebra lineal computacional, ALC, resueltos, guías resueltas},
    colorlinks=true,
...
%% Info SOCIAL
\def\dirRepo{https://github.com/nad-garraz/algebraLinealComputacional}
