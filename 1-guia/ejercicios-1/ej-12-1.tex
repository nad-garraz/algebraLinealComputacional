  ...
  \item[(\red{$\Rightarrow$})]
        ...
        $$
          \begin{array}{c}
            ...
            i
            \ub{(b_1 \cdot v_1 + \cdots + b_k \cdot v_k)}{\llamada4} = 0
          \end{array}
        $$
        Las combinetas en $\llamada3$ y $\llamada4$ cumplen nuestra hipótesis de $\llamada1$, porque los $a_i$ y los $b_i \en \reales$,
