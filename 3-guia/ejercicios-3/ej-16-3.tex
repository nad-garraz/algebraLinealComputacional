...
\parrafoDestacado{
  ...
  $$
  igual que en ele ítem (a), \magenta{pero si bien es simétrica la expresión matricial no se puede concluir en
    esta base que sea un \textit{proyector ortogonal}}
}
