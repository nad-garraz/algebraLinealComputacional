...
\begin{enumerate}[label=\tiny\purple{\faIcon{snowman}}]
  ...
  \item \textit{Propiedades de una transformación lineal:}
        ...
        \begin{itemize}
          \item $f$ se dice \textit{monomorfismo} si es inyectiva.
          \item $f$ se dice \textit{epimorfismo} si es suryectiva.
          \item $f$ se dice \textit{isomorfismo} si es \textit{mono} y \textit{epi}.
        \end{itemize}

\item \textit{Norma}
        Sea $||\cdot|| : K^n \to \reales\geq0  $. Entonces $\norma$ es 
        norma si cumpe:
        \begin{enumerate}[label=\arabic*)] 
         \item $||x|| \geq 0$ y $||x|| = 0 \sii x = 0, x \en K^n$ 
         \item $||\alpha x|| = \alpha ||x||$ con $\alpha \en K$ y $x \en K^n$
         \item $||x + y|| \leq ||x|| + ||y||$ con $x,y \en K$
         \end{enumerate}
 \item
         Ejemplos:
         \begin{itemize}
                 \item Norma 2:$||x||_2 = \sqrt{\sumatoria{k=0}{n} |x_k|^2 }  $
                 \item Norma p:$||x||_p = \sqrt{\sumatoria{k=0}{n} |x_k|^p }  $
                 \item Norma p:$\limite{p}{\infty} ||x||_p = max|x_i|$
         \end{itemize}
\end{enumerate}
