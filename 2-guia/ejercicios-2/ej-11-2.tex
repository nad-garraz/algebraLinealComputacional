...
\hyperlink{teoria-2:normas}{Acá están las definiciones de las normas que se usan en el ejercicio {\tiny \click }})
...
$$
  ...
  \igual{\red{!}}
  \maximo_{1\leq i \leq n} |x_i|
  \cdot
  \ub{
    \sqrt{
      \parentesis{\frac{x_1}{x_i}}^2 + \cdots + \ua{1}{i-\text{ésimo lugar}} + \cdots + \parentesis{\frac{x_n}{x_i}}^2
    }
  }{
    \geq 1
  }
